# Hi, I'm Nakul Bhatnagar 👋  
  ...
  AWS & Cloud Enthusiast |  Tech Trainer  
  Focused on building scalable cloud-backed and full-stack solutions
...
- Cloud & full-stack projects using **AWS, Node.js, MongoDB, React Native**
- An **AI-integrated Emergency SOS App** with voice trigger, live location & alerts

**Looking to Collaborate On**
- AWS-based cloud projects involving real architecture decisions  
- Full-stack web & mobile applications  
- Open-source projects (Backend, DevOps, AI integration)

**Looking for Help With**
- Designing **cost-efficient AWS architectures**
- Real-time systems (**WebSockets, live tracking**)
- Production-ready deployments & scalability
...
**Ask Me About**
- AWS (cloud basics → advanced, explained simply)
